var imgDataPath = '/images/photoslist.json'; //图片名称高宽信息json文件路径
var imgPath = '/images/background/';  //图片访问路径
var imgMaxNum = 1000; //图片显示数量

var windowWidth = window.innerWidth
|| document.documentElement.clientWidth
|| document.body.clientWidth;
if (windowWidth < 768) {
    var imageWidth = 175; //图片显示宽度(手机端)
} else {
    var imageWidth = 310; //图片显示宽度
}
